...
const workoutPlans = [
  {
    title: "Fat Burn Plan",
    description: "A plan focused on reducing body fat through cardio and high-rep workouts.",
    fitnessLevel: "Beginner",
    exercises: [
      { name: "Jumping Jacks", sets: 3, reps: "30 seconds", rest: "30s", day: "Monday" },
      { name: "Burpees", sets: 3, reps: "12", rest: "45s", day: "Monday" },
      { name: "Mountain Climbers", sets: 3, reps: "20", rest: "30s", day: "Tuesday" },
      { name: "Running", sets: 1, reps: "20 mins", rest: "-", day: "Wednesday" }
    ]
  },
  {
  ...
  },
  {
    ...
    exercises: [
      ...
      { name: "Treadmill Run", sets: 1, reps: "5 km", rest: "-", day: "Wednesday" },
      { name: "Jump Rope", sets: 5, reps: "2 mins", rest: "30s", day: "Thursday" }
    ]
  },
  {
    title: "Lean & Toned Plan",
    description: "High-rep, low-rest workouts for toning muscles and reducing fat.",
    fitnessLevel: "Beginner",
    exercises: [
      { name: "Bodyweight Squats", sets: 4, reps: "20", rest: "30s", day: "Monday" },
      { name: "Lunges", sets: 3, reps: "15 each leg", rest: "30s", day: "Tuesday" },
